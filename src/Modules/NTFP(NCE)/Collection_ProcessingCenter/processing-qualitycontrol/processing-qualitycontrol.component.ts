...
@Component({
  selector: 'app-processing-qualitycontrol',
  templateUrl: './processing-qualitycontrol.component.html',
  styleUrl: './processing-qualitycontrol.component.css'
})
export class ProcessingQualitycontrolComponent implements OnInit {
    ...
    @ViewChild('grid') gridComponent!: CustomGridComponent;
      ...
      ngOnInit(): void {
        this.LoadprocessingQualityControl();
  ...
  columns: GridColumn[] = [
    ...
    { field: 'name_of_center', header: 'Center Name' },
    { field: 'ntfp_resource_type', header: 'NTFP Resource Type' },
    { field: 'name', header: 'Name' },
    { field: 'input_quantity', header: 'Input Quantity' },
    { field: 'quantity_unit', header: 'Quantity Unit' },
    { field: 'ntfp_input_cost', header: 'Input Cost' },
    { field: 'other_input_cost', header: 'Other Input Cost' },
    { field: 'cost_of_processing', header: 'Processing Cost' },
    { field: 'total_cost', header: 'Total Cost' },
    { field: 'output_product_cat', header: 'Output Product Category' },
    { field: 'output_product_subcat', header: 'Output Product Subcategory' },
    { field: 'output_quantity', header: 'Output Quantity' },
    { field: 'output_quantity_unit', header: 'Output Quantity Unit' },
    { field: 'quality_of_resource', header: 'Quality of Resource' },
    { field: 'output_volume', header: 'Output Volume' },
...

    {
      ...
      // ================= LOAD DATA =================
      LoadprocessingQualityControl() {
    this.coreservices.getNtfpProcessQualityControl(this.userid).subscribe({
      next: (res: any) => {
        ...
        this.data = [...rawData.map((item: any, index: number) => ({
          ...
          Sub_module: "NTFP Collection and Processing Control",
          child_Module: "Processing and Quality Control",

          ntfpprocessingQualityControl:true,
          sno: index + 1,
    ...
    this.coreservices.getNtfpProcessQualityControlImage(id, imageName, 'ntfp_nce_process_quality_control').subscribe({
      next: (res: any) => {
  ...
  switch (event.action) {
    case 'view_ntfp_processing':
      ...
      const module = "ntfp_nce_process_quality_control";
   ...
   this.coreservices.commonUpdates(module,Payload).subscribe({
    next: (res: any) => {
      if (res) {
        ...
        this.LoadprocessingQualityControl(); // Refresh grid
      } else {
