...
@Component({
  selector: 'app-fisheries-planning',
  templateUrl: './fisheries-planning.component.html',
  styleUrl: './fisheries-planning.component.css'
})
export class FisheriesPlanningComponent {
  isLoading = false;
    data: any[] = [];
