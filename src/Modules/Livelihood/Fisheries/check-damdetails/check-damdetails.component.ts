...
@Component({
  selector: 'app-check-damdetails',
  templateUrl: './check-damdetails.component.html',
  styleUrl: './check-damdetails.component.css'
})
export class CheckDamdetailsComponent implements OnInit{
  ...
  { field: 'check_dam_id', header: 'Check Dam ID' },
  { field: 'shg_name', header: 'SHG Name' },
  { field: 'model', header: 'Model' },
  { field: 'volume', header: 'Volume' },
  { field: 'nature_of_check_dam', header: 'Nature of Check Dam' },
 ...
 { field: 'bo_rej_comments', header: 'Bo Reject Comments' },
  ...
  loadcheckdamdetails() {
    this.coreservices.getFiCheckdamDetails(this.userid).subscribe({
      next: (res: any) => {
      ...
      this.data = [
        ...rawData.map((item: any, index: number) => ({
          ...
          Sub_module: "Fisheries",
          child_Module: "Check Dam Details",
  ...
  // ================= IMAGE POPUP =================
    ...
    this.coreservices.getFiCheckdamImage(id, imageName, 'fi_checkdam_details').subscribe({
      next: (res: any) => {
  ...
  switch (event.action) {
    case 'checkdam_view':
      ...
      const module = "fi_checkdam_details";
